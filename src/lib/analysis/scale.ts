 ...
 * فلا يصح أن تكون أرقاماً سحرية مبعثرة في الكود. تُستخدم هذه القيم كمرجع
 * افتراضي فقط عند غياب توصيف السؤال؛ أما الحساب الفعلي فيحمل حدود كل سؤال.
 */

/** السُّلَّم الافتراضي عند غياب توصيف صريح للسؤال */
