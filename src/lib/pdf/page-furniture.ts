 ...
 *   - ولا ترث خطوطها، ولا تنتظر تحميل خط ويب: `@font-face` بـ data URI يُهمل
 *     داخلها (مختبر)، فالعربية هنا تعتمد على Cairo مثبّتاً كخط نظام — يثبّته
 *     `installReportFonts` في generate-analysis-pdf.ts.
 */
